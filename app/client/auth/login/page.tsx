...
export default function ClientLoginPage() {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md w-full p-6 bg-white rounded-lg shadow-lg">
          ...
          <p className="text-gray-600 text-center">
            Мы отправили ссылку для входа в личный кабинет клиента на <strong>{email}</strong>
          </p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full p-6 bg-white rounded-lg shadow-lg">
        <h1 className="text-2xl font-bold text-center mb-2">Вход для клиентов</h1>
        ...
        <div className="mt-6 text-center">
          <a href="/auth/login" className="text-sm text-gray-500 hover:text-gray-700">
            Вы психолог? Войти в кабинет психолога
          </a>
        </div>
      </div>
    </div>
