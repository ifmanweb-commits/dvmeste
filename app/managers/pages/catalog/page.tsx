...
import { getOrCreateCatalogPage, updateCatalogPageSections } from "@/lib/actions/manager-pages";
...
export default async function ManagerCatalogPageSettings({
  searchParams,
}: {
        ...
        <div className="mx-auto max-w-[1900px]">
          ...
          <div className="rounded-xl border-2 border-[#4CAF50]/20 bg-white p-4 shadow-sm sm:rounded-2xl sm:p-6 lg:p-8">
            ...
            <p className="mt-2 text-xs text-gray-600 sm:text-sm">
              Настройка HTML-блоков страницы <code>/psy-list</code>. Верхний блок выводится до каталога, нижний —
              после. Если верхний блок пустой, каталог показывается сразу после меню.
            </p>
            ...
            <form action={updateCatalogPageSections} className="mt-6 space-y-6">
              <div>
                ...
                <textarea
                  ...
                  className="mt-2 w-full rounded-lg border border-gray-300 px-3 py-2 font-mono text-sm text-gray-900 focus:border-[#4CAF50] focus:outline-none focus:ring-2 focus:ring-[#4CAF50]/20"
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <button
                  type="submit"
                  className="inline-flex items-center justify-center rounded-lg bg-[#4CAF50] px-5 py-2.5 text-sm font-medium text-white hover:bg-[#43A047]"
                >
                  Сохранить
                </button>
                <Link
